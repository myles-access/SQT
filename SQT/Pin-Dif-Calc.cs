...
namespace SQT
{
    public partial class Pin_Dif_Calc : Form
    {
        ...
        public bool LoadProcessManager(string loadSelection)
        {
        ...
        private void LoadXMLIntoForm()
        {
            ...
            LoadPreviousXmlTb(tbMainAccomodation, tBMainAddress, tbMainBlankets, tbMainCartage, tbMainDuct, tbMainEntranceGuards, tbMainMargin,
                 ...
                 tbLift10Price, tbLift10Floors, tbLift11Price, tbLift11Floors, tbLift12Price, tbLift12Floors, tBMainQuoteNumber, tbfname, tblname, tbphone, tbAddress1, tbAddress2, tbAddress3, tbLiftNumbers, tbTypeofLift,
                    ...
                    tb2AuxCOPLocation, tb2CarDepth, tb2CarDoorFinishText, tb2CarHeight, tb2CarLoad, tb2CarWidth, tb2CeilingFinishText, tb2ControlerLocationText, tb2COPFinishText, tb2Designations,
        ...
        public void SaveProcessManager()
        {
            // compile all data from sheet into a dictionary for saving
            saveData.Clear();
            Save();
            // call an XML writer to write it into a document that is saved 
            SaveReloadXMLFile(saveData);
        }

        private void Save()
        {
            //save items in the price form
