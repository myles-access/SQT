...
namespace SQT
{
    public partial class QuoteInfo9 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            f.WordData("AE172", f.RadioButtonHandeler(null, radioButton20, radioButton19));// COP finish
            f.WordData("AE173", f.RadioButtonHandeler(null, radioButton2, radioButton1));// button type 
            f.WordData("AE174", f.RadioButtonHandeler(null, radioButton3, radioButton4));// LED colour
            ...
            f.WordData("AE191", f.RadioButtonHandeler(textBox5, radioButton39, radioButton40));//key switch location 
