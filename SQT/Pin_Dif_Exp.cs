    ...
    public partial class Pin_Dif_Exp : Form
    {
        ...
        private void SaveData()
        {
            ...
            if (pageTracker>=1)
            {
                ...
                f.WordData(prefix + "AE105", tbfname.Text); //first name
                f.WordData(prefix + "AE106", tblname.Text);//last name
                f.WordData(prefix + "AE107", tbphone.Text);//phone number
                f.WordData(prefix + "AE108", tbAddress1.Text);//address 1
                f.WordData(prefix + "AE109", tbAddress2.Text);//address 2
                f.WordData(prefix + "AE110", tbAddress3.Text);//address 3
                f.WordData(prefix + "AE111", f.RadioButtonHandeler(null, rbSL, rbWittur, rbSumasa)); //supplier
                f.WordData(prefix + "AE114", tbLiftNumbers.Text);//lift number
                f.WordData(prefix + "AE115", tbTypeofLift.Text);//type of lift
                f.WordData(prefix + "AE215", "Full Collective"); //control type, not changable 
                f.WordData(prefix + "AE116", f.RadioButtonHandeler(null, rbIndependentServiceYes, rbIndependentServiceNo));//independent service
                f.WordData(prefix + "AE117", f.RadioButtonHandeler(null, rbLoadWeighingNo, rbLoadWeighingYes));//load weighing
                ...
                f.WordData(prefix + "AE132", f.RadioButtonHandeler(null, rbTrimmerBeamsNo, rbTrimmerBeamsYes));//trimmer beams
                f.WordData(prefix + "AE133", f.RadioButtonHandeler(null, rbFalseFloorYes, rbFalseFloorNo));//false floor
                ...
                {
                    f.WordData(prefix + "AE142", "NOTE: " + tbLiftCarNotes.Text);//notes
                }
                else
                {
                ...
                f.WordData(prefix + "AE167", f.RadioButtonHandeler(null, rbProtectiveBlanketsNo, rbProtectriveBlanketsYes)); // protective blankets 
                ...
                f.WordData(prefix + "AE189", f.RadioButtonHandeler(null, rbVoiceAnnunciationNo, rbVoiceAnnunciationYes));//voice annunciation 
                ...
                f.WordData(prefix + "AE210", f.RadioButtonHandeler(null, rbOutofServiceNo, rbOutofServiceYes));//out of service 
